...
show_version = ''' Cisco IOS Software, C880 Software (C880DATA-UNIVERSALK9-M), Version 15.0(1)M4, RELEASE SOFTWARE (fc1)
Technical Support:
Copyright (c) 1986-2010 by Cisco Systems, Inc.
Compiled Fri 29-Oct-10 00:02 by prod_rel_team
ROM: System Bootstrap, Version 12.4(22r)YB5, RELEASE SOFTWARE (fc1)
...
for line in show_version_list:
    ...
    if "Cisco IOS Software" in line:
        ...
        #print os_version
        router_dict['Version'] = os_version.split("Version ")[1]
        #print router_dict

    if "bytes of memory" in line:
        router_model = line.split(' ')
        #print router_model
        router_dict['Model'] = router_model[1]
        #print router_dict

    if 'Processor board ID' in line:
        processor_id = line.split(" ")
        router_dict['Serial_Number'] = processor_id[3]
        #print router_dict


    if 'uptime is' in line:
        uptime_time = line.split("uptime is")
        #print uptime_time
        router_dict['Uptime'] = uptime_time[1]
